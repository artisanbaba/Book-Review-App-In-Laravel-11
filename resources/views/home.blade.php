                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-11 col-md-11">
                                    <input type="text" name="keyword" class="form-control form-control-lg" placeholder="Search by title" value="{{ Request::get('keyword') }}">
                                </div>
                            ...
                            <div class="card border-1 shadow-lg">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="star-rating d-inline-flex ml-2" title="">
                                        ...
                                        <span class="theme-font text-muted">{{ ($ratingCount > 1) ? "($ratingCount Reviews)" : "($ratingCount Review)" }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>  
