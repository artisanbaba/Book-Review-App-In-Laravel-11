            ...
            <div class="container">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex align-items-center navigation">
                        @if (Auth::check())
                            <a href="{{ route('account.showProfile') }}" class="text-white">Account</a> 
                        @else
                            <a href="{{ route('account.showLogin') }}" class="text-white">Login</a>&emsp;<span class="text-white">|</span>&emsp;
